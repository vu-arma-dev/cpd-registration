function APP_RegAprToRobot_PSM_Kidney(varargin)
...
RobotExplrPtName = 'PSMExplrPtCloud_KidneyVU.ply';
...
%% register
SaveResultsFolder = [PC_path_PSM,'RegAprToRobotKidney\'];
AprioriMerge = [ptApriori.Location;];
if ~exist(SaveResultsFolder,'dir')
    mkdir(SaveResultsFolder);
end
close all;
[T,C]= rigidReg(ptRobotExplr.Location,AprioriMerge,'max iter',Max_Iter);
